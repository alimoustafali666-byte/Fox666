...
from app.modules.support.rate_limit import assistant_ask_rate_limiter, ticket_create_rate_limiter
...
def _reset_rate_limiters() -> Iterator[None]:
    ...
    ticket_create_rate_limiter.reset_all()
    assistant_ask_rate_limiter.reset_all()
    yield
    login_rate_limiter.reset_all()
    ticket_create_rate_limiter.reset_all()
    assistant_ask_rate_limiter.reset_all()
